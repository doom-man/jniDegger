    ...
    public static String getAllAppSign(Context context, String packageName) {
        ...
        try {
            ...
            builder.append((int) signatures[signatures.length - 1]);
                Log.d(TAG, packageName + " sign:" + builder.toString());
                Log.d(TAG, packageName + " hashCode:" + info.signatures[0].hashCode());
...
//            return Base64.encodeToString(byteArray,Base64.NO_WRAP);
    ...
    public static void dumpSign(Context context) {
        Log.e(TAG, "sign HashCode:" + getSignHashCode(context));
        Log.e(TAG, "sign Md5:" + getSignMd5(context));
        Log.e(TAG, "sign Sha1:" + getSignSHA1(context));
    }
